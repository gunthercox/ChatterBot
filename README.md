...
# ChatterBot :busts_in_silhouette:
...
**Corpus contributions are welcome! Please make a pull request.**  :fire:
...
# Development pattern for contributors :point_down:
